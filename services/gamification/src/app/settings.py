...
SECRET_KEY = require_env("DJANGO_SECRET_KEY", insecure_default="gamification-secret")
...
BFF_INTERNAL_HMAC_SECRET = require_env(
    ...
    insecure_default="gamification-internal-hmac-secret",
)
...
GAMIFICATION_RETENTION_PUBLISHED_OUTBOX_DAYS = int(
    os.getenv("GAMIFICATION_RETENTION_PUBLISHED_OUTBOX_DAYS", "30")
)
