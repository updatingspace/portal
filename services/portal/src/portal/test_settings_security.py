            ...
            self._import_settings(
                {
                    ...
                    "ALLOWED_HOSTS": "localhost,portal",
        ...
        settings_module = self._import_settings(
            {
                "DJANGO_DEBUG": "False",
                "DJANGO_SECRET_KEY": "test-secret",
                "DJANGO_ALLOWED_HOSTS": "localhost,portal",
                "DATABASE_URL": "postgres://user:pass@db:5432/portal_db",
                "BFF_INTERNAL_HMAC_SECRET": "test-hmac-secret",
            }
        )

        self.assertEqual(settings_module.ALLOWED_HOSTS, ["localhost", "portal"])
