    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('button_text', models.CharField(default='OK', max_length=100, verbose_name='Текст кнопки')),
                ('button_url', models.CharField(blank=True, max_length=500, verbose_name='Ссылка кнопки')),
                ('modal_type', models.CharField(choices=[('info', 'Информация'), ('warning', 'Предупреждение'), ('success', 'Успех'), ('promo', 'Промо')], default='info', max_length=50, verbose_name='Тип модалки')),
