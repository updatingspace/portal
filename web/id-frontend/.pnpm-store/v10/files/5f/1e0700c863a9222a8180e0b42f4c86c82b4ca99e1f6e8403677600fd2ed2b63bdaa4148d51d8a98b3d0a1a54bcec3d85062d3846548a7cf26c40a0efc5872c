...
exports.getPluralValues = exports.hasNestingTranslations = exports.mapErrorCodeToMessage = exports.ErrorCode = void 0;
...
const hasNestingTranslations = (keyValue) => {
    var _a;
...
exports.hasNestingTranslations = hasNestingTranslations;
const getPluralValues = (keyValue) => {
...
exports.getPluralValues = getPluralValues;
