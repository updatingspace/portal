...
export declare const SheetContentContainer: React.ComponentType<Omit<MobileContextProps & SheetContentBaseProps & Partial<SheetContentDefaultProps>, keyof import("../index.js").WithMobileProps>>;
export {};
