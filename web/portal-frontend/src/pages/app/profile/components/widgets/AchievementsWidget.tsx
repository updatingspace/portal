...
export const AchievementsWidget: React.FC<AchievementsWidgetProps> = ({ items }) => {
  ...
  return (
    <Card view="filled" className="profile-widget">
      ...
      <Button view="flat" size="s" onClick={() => navigate(`${routeBase}/profile/achievements`)}>
        {profileHubStrings.achievements.showAll}
      </Button>
    </Card>
  );
};
